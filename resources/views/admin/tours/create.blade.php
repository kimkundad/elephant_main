                                ...
                                <div class="row g-4 mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="tour-quill-field">
                                            <div class="tour-quill-editor js-tour-quill" data-target="description_th">{!! old('description_th') !!}</div>
                                            <textarea name="description_th" class="form-control mt-3 js-tour-quill-input" rows="6">{{ old('description_th') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Full Description (EN)</label>
                                        <div class="tour-quill-field">
                                            <div class="tour-quill-editor js-tour-quill" data-target="description_en">{!! old('description_en') !!}</div>
                                            <textarea name="description_en" class="form-control mt-3 js-tour-quill-input" rows="6">{{ old('description_en') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
